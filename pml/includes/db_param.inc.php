...
$_tableau_databases[0]="ludoDB" ;
$_libelle_databases[0]="ludoDB" ;
...
switch(LOCATION):
	...
	case 'ludoDB':
		...
		define('USER_NAME', 'ludo');		// nom utilisateur
		define('USER_PASS', 'ludo');		// mot de passe
		define('DATA_BASE', 'ludoDB');		// nom base de données
		define('SQL_TYPE',  'mysql');			// Type de serveur de base de données
